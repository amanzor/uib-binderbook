...
OFFICE = [('220 License Rent', -500.00), ('Systems', -224.00)]
EXPENSES = [OFFICE[0], OFFICE[1], ('MVRs', round(D['adj_total'], 2))]
...
story += [Spacer(1, 10), Paragraph(
    ...
    'not attributed to Doral. <b>220 License Rent ($500) and Systems ($224)</b> are office figures provided for July '
...
s2 += [Spacer(1, 12), Paragraph(
    ...
    'twice. 220 License Rent ($500) and Systems ($224) are office figures provided for July and appear on no carrier '
    'statement.', note)]
doc2.build(s2)
